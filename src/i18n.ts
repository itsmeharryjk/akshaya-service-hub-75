    ...
    resources: {
      en: {
        translation: {
          ...
          notificationsDescription: "Stay informed about your application status, payment confirmations, and important government announcements.",
          unread: "Unread",
          all: "All",
          services: "Services",
          system: "System",
          ...
          noUnreadNotificationsDescription: "You're all caught up! Check back later for new updates.",
          noNotificationsDescription: "You'll receive notifications here about your applications and important updates.",
          success: "Success",
          warning: "Warning",
          error: "Error",
          info: "Info",
          ...
          notificationSettingsDescription: "Customize how and when you receive notifications about your applications and government updates.",
      ...
      ml: {
        translation: {
          ...
          notificationsDescription: "നിങ്ങളുടെ അപേക്ഷയുടെ സ്ഥിതി, പേയ്‌മെന്റ് സ്ഥിരീകരണങ്ങൾ, പ്രധാന സർക്കാർ പ്രഖ്യാപനങ്ങൾ എന്നിവയെക്കുറിച്ച് അറിയിക്കുക.",
          unread: "വായിക്കാത്തവ",
          all: "എല്ലാം",
          services: "സേവനങ്ങൾ",
          system: "സിസ്റ്റം",
          ...
          confirmDeleteNotification: "ഈ അറിയിപ്പ് ഇല്ലാതാക്കണമെന്ന് ഉറപ്പാണോ?",
          notificationDeleted: "അറിയിപ്പ് ഇല്ലാതാക്കി",
          noUnreadNotifications: "വായിക്കാത്ത അറിയിപ്പുകളില്ല",
          noUnreadNotificationsDescription: "നിങ്ങൾ എല്ലാം വായിച്ചു കഴിഞ്ഞു! പുതിയ അപ്‌ഡേറ്റുകൾക്കായി പിന്നീട് പരിശോധിക്കുക.",
          noNotificationsDescription: "നിങ്ങളുടെ അപേക്ഷകളെക്കുറിച്ചും പ്രധാന അപ്‌ഡേറ്റുകളെക്കുറിച്ചും നിങ്ങൾക്ക് ഇവിടെ അറിയിപ്പുകൾ ലഭിക്കും.",
          success: "വിജയം",
          ...
          notificationSettingsDescription: "നിങ്ങളുടെ അപേക്ഷകളെക്കുറിച്ചും സർക്കാർ അപ്‌ഡേറ്റുകളെക്കുറിച്ചും എങ്ങനെ, എപ്പോൾ അറിയിപ്പുകൾ ലഭിക്കണമെന്ന് ഇഷ്ടാനുസൃതമാക്കുക.",
          manageNotifications: "അറിയിപ്പുകൾ മാനേജ് ചെയ്യുക",
